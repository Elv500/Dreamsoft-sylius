...
class AssertionTaxonImagesError:

    @staticmethod
    def assert_taxon_images_error(response_json, code, message):
        try:
    ...
    @staticmethod
    def assert_taxon_images_error_request(response_json, status, detail):
        try:
