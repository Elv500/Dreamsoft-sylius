...
from src.services.taxons_call import TaxonsCall
...
def view_taxon(auth_headers):
    ...
    taxon1 = TaxonsCall.create_taxon(auth_headers, payload_taxon1)
    taxon2 = TaxonsCall.create_taxon(auth_headers, payload_taxon2)
